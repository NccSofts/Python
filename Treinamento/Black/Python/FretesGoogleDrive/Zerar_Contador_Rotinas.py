...
print('Executando Zerar_Contador_Rotinas')
cursor.execute("EXEC PowerBiv2..Zerar_Contador_Rotinas")

print('Executando Zerar_Contador_Rotinas')
cursor.execute("EXEC PowerBiv2..EXEC POWERBIV2..PROC_RUN_ROTINAS 'Zerar_Contador_Rotinas'")
