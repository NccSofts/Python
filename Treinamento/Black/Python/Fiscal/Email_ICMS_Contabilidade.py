    ...
    query = """\
                    ...
                    (
                        SELECT 
                            R.Numero,
                            R.Serie,
                            CONCAT(RTRIM(R.Numero),'.',RTRIM(R.Serie)) NF,
                            F.ForCli Fornecedor,
                            R.DataEmissao,
                            R.DataAgendamento,
                            R.DataRecebimento,
                        ...
                        (
                            SELECT 
                                ...
                                ForCli,
                                Data
                            FROM DataWareHouse..MapaFiscal
                            GROUP BY Numero, ForCli, Data
                        ) F ON F.Numero = CONCAT(RTRIM(R.Numero),'.',RTRIM(R.Serie))

) R ON R.Numero LIKE NF_COMPRA 
...
ORDER BY NF_COMPRA
    ...
    receiver_email = ['fiscal@maisproxima.com.br','Adriano Goes <adriano.goes@maisproxima.com.br>','Artur Nucci Ferrari <ti@maisproxima.com.br>','Leonardo Zuim <logistica.es@maisproxima.com.br>','Wellington Fernandes <wellington.fernandes@b2finance.com>','igor.chaves@maisproxima.com.br','Davi Leite Lemos <davi.lemos@b2finance.com>','Claudio Junior <claudio.junior@b2finance.com>','Adriana Bellomo <adriana.bellomo@b2finance.com>']
