...
# delete = """\
#             DELETE FROM PowerBiv2..Tabela_Consulta_Pedidos_Lenoxx
#
#             FROM PowerBiv2..Tabela_Consulta_Pedidos_Lenoxx L
#             INNER JOIN
#             (
#                 SELECT
#                     NF,
...
#                         LEN(NF) >= 6
#                 GROUP BY NF, Pedido, [Data Faturamento], [Previsao Entrega], SERIE_NF
#             ) B ON B.NF = L.NF AND B.Pedido = L.PedidoIMPX
#           """
...
browser.get('https://portal.pacificimp.com.br/portal_pacific/autenticar_usuario.php')
...
botao_entrar = browser.find_element_by_xpath(
    '//*[@id="form_login"]/table/tbody/tr/td[2]/table/tbody/tr[4]/td/a/span/span[1]')

usuario.send_keys('igor.chaves@maisproxima.com.br')
senha.send_keys('LNX21')
botao_entrar.click()
...
for items in df.itertuples():
    ...
    browser.get('https://portal.pacificimp.com.br/portal_pacific/sistema_forca_vendas/gerenciar_pedidos.php')
    ...
    botao_procura.click()
    time.sleep(3)
    num_pedido = browser.find_element_by_xpath('/html/body/div[25]/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[1]/td[1]/div').text

    tag = browser.find_element_by_xpath(
        '/html/body/div[25]/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[1]/td[9]/div/a[4]')
