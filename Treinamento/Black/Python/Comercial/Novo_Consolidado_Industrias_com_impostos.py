...
resumo_pendentes = pd.pivot_table(pendentes_entrega, values=['Valor'], aggfunc='sum',
                                  index=['Industria', 'AnoMes_Fat', 'NF', 'SERIE_NF', 'Pedido', 'Data_Pedido', 'Previsao Entrega', 'CNPJ','Razao_Social'], margins=True,
...
if diasemana < 5:
    ...
    receiver_email = ['sheila.gomes@maisproxima.com.br', 'igor.chaves@maisproxima.com.br', 'Simone Dario <simone.dario@maisproxima.com.br>',
                      'Artur Nucci Ferrari <ti@maisproxima.com.br>', 'Tatiana Mello <tatiana.mello@maisproxima.com.br>','Adriano Goes <adriano.goes@maisproxima.com.br>','Tesouraria Mais Próxima <tesouraria@maisproxima.com.br>']
