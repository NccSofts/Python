...
query = """\
            SELECT 
                ...
                IIF(SUM(Valor) <> 0, 'S','N') Total
            FROM PowerBIv2..Razao_Contabil_Transitorias
            WHERE ContaX = '110601010099'
...
try:
    ...
    if diasemana < 5:
        if Total == "S":
            ...
            <h1 style="color: #5e9ca0;"><strong style="color: #000000; font-size: 14px;">Segue relação de pendências da conta 110601010099 - CONTA TRANSITORIA A RECEBER.</strong></h1>
