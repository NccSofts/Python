...
print("EXEC Datawarehouse..FechamentoLogistica")
comando = 'EXEC Datawarehouse..FechamentoLogistica ' + "'" + year + "'" + ',' + "'" + month + "'"
print(comando)
...
print("EXEC Powerbiv2..Industria_Pedido_NFe_Historico")
comando = 'EXEC Powerbiv2..Proc_Industria_Pedido_NFe_Historico'
print(comando)
cursor.execute(comando)
