...
def envia_email_erro(script_python, msg_erro,nccstring):
...
try:
        ...
        if erro == 'errorMessage':
            ...
            for items in obj['pricingHaulerList']:
                ...
                try:
                    ...
                    print('NCc Test---> Erro ao simular o pedido ' + Pedido + 'do cliente ' + Cliente)
    ...
    error_string = str(error)
    nome_arquivo = str(os.path.basename(__file__))
    envia_email_erro(nome_arquivo, error_string,querystring)